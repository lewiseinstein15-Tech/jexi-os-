...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — web-development/senior-frontend · risk=safe · source=https://github.com/alirezarezvani/claude-skills · added=2026-03-07
whenToUse: "Use when scaffolding a new React or Next.js project with TypeScript and Tailwind CSS."
allowedTools: []
---

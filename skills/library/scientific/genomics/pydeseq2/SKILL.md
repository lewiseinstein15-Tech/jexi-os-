...
whenToUse: Use when the task matches this skill's scope: Differential gene expression analysis for bulk RNA-seq with PyDESeq2, including formulaic designs, Wald tests, FDR correction, LFC shrinkage, and result visualization.
allowedTools: [Read, Write, Edit, Bash]
domain: genomics
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/pydeseq2/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/pydeseq2/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

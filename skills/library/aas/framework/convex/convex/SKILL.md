...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — framework/convex · risk=safe · source=https://docs.convex.dev · added=2026-02-27
whenToUse: "Use when building a new project with Convex as the backend"
allowedTools: []
---

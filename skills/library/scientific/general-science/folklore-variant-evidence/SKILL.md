...
whenToUse: Use when the task matches this skill's scope: "Retrieve ClinGen gene-disease validity assertions for a public gene or disease, and review source-linked public evidence and literature for one supported GRCh38 germline nuclear SNV or simple indel through Folklore Clinical Variant Interpretation MCP. Use when a scientific agent must branch deterministically on resolved, ambiguous, not-found, invalid, unsupported, or unavailable variant outcomes; chain a resolved public variant into related literature or publication details; or preserve evidence provenance without accepting patient, phenotype, family, segregation, or private case data."
allowedTools: [Read, Write, Edit, Bash]
domain: general-science
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/folklore-variant-evidence/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/folklore-variant-evidence/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

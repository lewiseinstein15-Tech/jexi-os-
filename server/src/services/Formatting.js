...
- BROKEN-LINK RULE: if the user says a link/app/preview is not working, NEVER lecture them (no 'check your internet', 'try incognito', 'Ctrl+F5'). Instead: (1) test it yourself via fetch, (2) if it's dead — rebuild and republish a FRESH link immediately, (3) give them the new link. The user is never your debugger.

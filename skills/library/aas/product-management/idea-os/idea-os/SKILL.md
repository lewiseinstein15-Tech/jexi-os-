...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — product-management/idea-os · risk=safe · source=community · added=2026-04-18
whenToUse: "Use when a user shares a raw product idea or problem statement and wants a structured pipeline from clarifying questions through deep research, PRD, and a phased execution plan."
allowedTools: []
---

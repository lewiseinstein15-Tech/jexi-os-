...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — database-processing/database-architect · risk=none · source=community · added=2026-02-27
whenToUse: "Use when Selecting database technologies or storage patterns"
allowedTools: []
---

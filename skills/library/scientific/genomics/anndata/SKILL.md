...
whenToUse: Use when the task matches this skill's scope: Data structure for annotated matrices in single-cell analysis. Use when working with .h5ad files or integrating with the scverse ecosystem. This is the data format skill—for analysis workflows use scanpy; for probabilistic models use scvi-tools; for population-scale queries use cellxgene-census.
allowedTools: [Read, Write, Edit, Bash]
domain: genomics
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/anndata/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/anndata/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

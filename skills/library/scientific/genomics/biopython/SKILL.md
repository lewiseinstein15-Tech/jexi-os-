...
upstreamPath: skills/biopython/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/biopython/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.
- License: MIT (upstream LICENSE.md, K-Dense Inc.); per-skill upstream license field: "Biopython License Agreement".

...
whenToUse: Use when the task matches this skill's scope: Process, clean, compare, and search tandem mass spectra with matchms. Use for MS/MS file I/O, metadata harmonization, peak filtering, spectral similarity, library matching, score matrices, and molecular-similarity networks. Use pyopenms instead for LC-MS feature detection or proteomics pipelines.
allowedTools: [Read, Write, Edit, Bash]
domain: cheminformatics
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/matchms/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/matchms/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — testing/k6-load-testing · risk=safe · source=community · added=2026-03-13
whenToUse: "Use when you need to load test HTTP APIs, WebSocket endpoints, or browser scenarios"
allowedTools: []
---

...
check('P1: 251 agents · 507 skills · 177 tools (got ' + report.counts.agents + '/' + report.counts.skills + '/' + report.counts.tools + ')', report.counts.agents === 252 && report.counts.skills === 508 && report.counts.tools === 199); // +3: goal tools (B132)

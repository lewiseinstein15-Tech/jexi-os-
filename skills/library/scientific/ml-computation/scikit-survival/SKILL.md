...
whenToUse: Use when the task matches this skill's scope: Build, evaluate, and audit right-censored or competing-risk survival workflows with scikit-survival, including leakage-safe preprocessing, model selection, probability prediction, and censoring-aware metrics.
allowedTools: [Read, Write, Edit, Bash]
domain: ml-computation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/scikit-survival/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/scikit-survival/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

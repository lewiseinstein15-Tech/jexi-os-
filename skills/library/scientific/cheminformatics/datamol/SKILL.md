...
whenToUse: Use when the task matches this skill's scope: Pythonic wrapper around RDKit with simplified interface and sensible defaults. Preferred for standard drug discovery including SMILES parsing, standardization, descriptors, fingerprints, clustering, 3D conformers, parallel processing. Returns native rdkit.Chem.Mol objects. For advanced control or custom parameters, use rdkit directly.
allowedTools: [Read, Write, Edit, Bash]
domain: cheminformatics
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/datamol/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/datamol/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

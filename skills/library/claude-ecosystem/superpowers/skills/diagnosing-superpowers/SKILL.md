...
whenToUse: "Use when a superpowers session went wrong and your human partner wants to know why — repeated work, ignored plans, stumbles, poor results, a skill that didn't fire, \"it took too long\", \"why is it so expensive\", \"what is it doing\" — or wants to build a bug report for the superpowers maintainers, for the current session or a past one identified by id or path, on any harness."
allowedTools: []
domain: claude-ecosystem
tier: reference-only
origin: obra/superpowers
upstreamPath: skills/diagnosing-superpowers/SKILL.md
...
## Import Provenance
- Source: obra/superpowers `skills/diagnosing-superpowers/SKILL.md` @ `5bf4e7801107`; body ported verbatim.
...
- External files: NOT vendored — upstream ships 19 auxiliary file(s) (prompts/analyst-common.md, prompts/cost-and-time.md, prompts/plan-adherence.md, prompts/quality-evidence.md, prompts/repeated-work.md, prompts/request-conflicts.md, …).

...
whenToUse: Use when the task matches this skill's scope: Explain and audit machine-learning predictions with SHAP. Use for selecting SHAP explainers and maskers, computing and validating feature attributions, handling multi-output explanations, and producing local or global SHAP visualizations.
allowedTools: ["Read, Bash"]
domain: ml-computation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/shap/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/shap/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

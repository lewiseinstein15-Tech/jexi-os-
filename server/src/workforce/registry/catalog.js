// LEGACY SPECIALIST CATALOG — data home (phase-6 Scope E migration).
//
// The 200+ specialist catalog and 100+ skill library moved VERBATIM out of
// services/AgentRoster.js (deleted in the same commit). This file is pure
// data + lookups: no composition, no imports from Planner — the composition
// helpers (composeTeam/skillsForTeam/rosterFor/...) live in the registry
// index (workforce/registry/index.js) which wraps the AUTHORITATIVE live
// roster (director/Employees.js) for stats and capability composition.
//
// Consumers must import from 'workforce/registry/index.js' (the single
// roster API surface), never from this file directly.

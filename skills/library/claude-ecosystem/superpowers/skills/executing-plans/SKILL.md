...
whenToUse: "Use when executing an implementation plan in the current session as the implementer yourself — your human partner chose inline execution, or no subagent tool is available"
allowedTools: []
...
## Import Provenance
- Source: obra/superpowers `skills/executing-plans/SKILL.md` @ `5bf4e7801107`; body ported verbatim.
...
- External files: NOT vendored — upstream ships 2 auxiliary file(s) (scripts/task-done, scripts/task-start).

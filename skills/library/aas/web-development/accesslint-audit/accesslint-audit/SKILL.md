...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — web-development/accesslint-audit · risk=safe · source=https://github.com/AccessLint/skills · added=2026-06-02
whenToUse: "Use this skill when the task matches this description: Find and fix WCAG 2.2 accessibility issues. Two modes — report (sweep a codebase or page, produce a prioritized written report, no edits) and fix (audit→edit→verify loop on a target). Prefers direct-CDP live-DOM auditing; falls back to a browser"
allowedTools: []
---

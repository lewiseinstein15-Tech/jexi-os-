  ...
  return (
    <div className="markdown-body text-[11px] leading-relaxed">
      <ReactMarkdown 
        ...
        components={{
          h1: ({node, ...props}) => <h1 className="text-[13px] font-bold text-[#00D26A] mt-3 mb-2 tracking-wide" {...props} />,
          h2: ({node, ...props}) => <h2 className="text-[12px] font-bold text-[#4A9EFF] mt-3 mb-1.5" {...props} />,
          ...
          blockquote: ({node, ...props}) => <blockquote className="border-l-2 border-[#00D26A] pl-3 italic text-gray-400 my-2" {...props} />,
          a: ({node, ...props}) => <a className="text-[#4A9EFF] underline hover:text-[#00D26A]" target="_blank" rel="noreferrer" {...props} />,
        }}
      >
        {cleanContent}
      </ReactMarkdown>

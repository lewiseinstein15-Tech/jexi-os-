...
tools:
  ...
  - codex
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — frontend/frontend-api-integration-patterns · risk=safe · source=community · added=2026-04-23
whenToUse: "Use when Connecting frontend apps (React, React Native, Vue, etc.) to backend APIs"
allowedTools: []
---

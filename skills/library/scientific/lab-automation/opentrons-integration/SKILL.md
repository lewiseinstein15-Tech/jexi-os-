...
whenToUse: Use when the task matches this skill's scope: Author, review, migrate, simulate, and troubleshoot official Opentrons Python Protocol API v2 protocols for Flex and OT-2 robots. Use for robot-specific liquid handling, deck and labware setup, pipettes, modules, runtime parameters, liquid classes, and Opentrons App analysis. Use pylabrobot instead when one workflow must support multiple robot vendors.
allowedTools: [Read, Write, Edit, Bash]
domain: lab-automation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/opentrons-integration/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/opentrons-integration/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

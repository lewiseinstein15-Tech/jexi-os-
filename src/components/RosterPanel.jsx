...
const CATEGORY_ACCENTS = {
  Core: '#FF8A3D', Research: '#22D3EE', News: '#34D399', Memory: '#F472B6',
  ...
  Medicine: '#FB7185', Quant: '#FBBF24', Engineering: '#A78BFA', AI: '#FF8A3D',
  ...
  Marketing: '#FBBF24', Productivity: '#FF8A3D', Platform: '#A1A1AA',
};

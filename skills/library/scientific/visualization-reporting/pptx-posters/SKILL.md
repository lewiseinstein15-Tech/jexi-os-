...
whenToUse: Use when the task matches this skill's scope: Create and audit editable scientific posters in macro-free PowerPoint (.pptx) from author-approved local content and assets. Use when the requested deliverable is a PowerPoint research/conference poster and exact physical, printer, accessibility, provenance, and package-security checks are required.
allowedTools: [Read, Write, Bash, Glob, Grep, Python]
domain: visualization-reporting
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/pptx-posters/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/pptx-posters/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

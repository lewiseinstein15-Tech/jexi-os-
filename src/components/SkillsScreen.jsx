...
const CATEGORY_ACCENTS = {
  Core: '#FF8A3D', Math: '#A78BFA', Science: '#22D3EE', Research: '#22D3EE',
  ...
  AI: '#FF8A3D', Knowledge: '#34D399', Quality: '#FB7185', Safety: '#FBBF24',
  Security: '#A78BFA', Creative: '#F472B6', Media: '#FBBF24', Business: '#34D399',
  Education: '#22D3EE', Marketing: '#FBBF24', Productivity: '#FF8A3D',
  Platform: '#A1A1AA', News: '#34D399', Perception: '#F472B6', DevOps: '#22D3EE',
};
const ACCENT_PALETTE = ['#FF8A3D', '#22D3EE', '#34D399', '#F472B6', '#A78BFA', '#FBBF24', '#FB7185', '#A1A1AA'];
...
const SOURCE_META = {
  'project-dsh': { label: 'PROJECT', color: '#FF8A3D', rank: 100 },

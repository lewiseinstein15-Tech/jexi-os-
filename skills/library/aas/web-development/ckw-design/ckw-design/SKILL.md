...
tools:
  ...
  - codex-cli
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — web-development/ckw-design · risk=safe · source=community · added=2026-06-16
whenToUse: "Use when **design-thinking** — Load for every design task. Defines purpose, tone, domain, color world, review bar, and cross-domain lens (cinema, architecture, marketing, UX, automotive, industrial design). See [design-thinking/SKILL.md](https://github.com/connerkward/ckw-design-skill/blob/main/desi"
allowedTools: []
---
## When to Use

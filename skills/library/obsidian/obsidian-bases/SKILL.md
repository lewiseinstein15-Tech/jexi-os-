...
whenToUse: "Create and edit Obsidian Bases (.base files) with views, filters, formulas, and summaries. Use when working with .base files, creating database-like views of notes, or when the user mentions Bases, table views, card views, filters, or formulas in Obsidian."
allowedTools: []
domain: obsidian
tier: reference-only
origin: kepano/obsidian-skills
upstreamPath: skills/obsidian-bases/SKILL.md
...
## Import Provenance
- Source: kepano/obsidian-skills `skills/obsidian-bases/SKILL.md` @ `3ccff5338ea700537839b21900aa5358a0402c98`; body ported verbatim.
...
- References: NOT vendored — upstream ships 1 auxiliary file(s) (references/FUNCTIONS_REFERENCE.md). Links to them in the body above are therefore unresolved in this port.

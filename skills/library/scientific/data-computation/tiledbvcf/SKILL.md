...
whenToUse: Use when the task matches this skill's scope: Efficient storage and retrieval of genomic variant data using TileDB. Scalable VCF/BCF ingestion, incremental sample addition, compressed storage, parallel queries, and export capabilities for population genomics.
allowedTools: [Read, Write, Edit, Bash]
domain: data-computation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/tiledbvcf/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/tiledbvcf/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

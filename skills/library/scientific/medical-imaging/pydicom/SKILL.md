...
whenToUse: Use when the task matches this skill's scope: Use pydicom to read, inspect, write, transform, and safely preflight local DICOM datasets and pixel data. Applies to DICOM metadata, transfer syntaxes, compression plugins, frames, private elements, JSON, and bounded de-identification review.
allowedTools: [Read, Write, Edit, Bash]
domain: medical-imaging
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/pydicom/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/pydicom/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

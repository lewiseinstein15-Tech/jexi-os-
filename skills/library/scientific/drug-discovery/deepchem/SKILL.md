...
whenToUse: Use when the task matches this skill's scope: Molecular ML with diverse featurizers and pre-built datasets. Use for property prediction (ADMET, toxicity) with traditional ML or GNNs when you want extensive featurization options and MoleculeNet benchmarks. Best for quick experiments with pre-trained models, diverse molecular representations. For graph-first PyTorch workflows use torchdrug; for benchmark datasets use pytdc.
allowedTools: [Read, Write, Edit, Bash]
domain: drug-discovery
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/deepchem/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/deepchem/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

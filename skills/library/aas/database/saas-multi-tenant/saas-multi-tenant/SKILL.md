...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — database/saas-multi-tenant · risk=safe · source=community · added=2026-03-28
whenToUse: "Use when The user is building a SaaS application where multiple customers share the same database"
allowedTools: []
---

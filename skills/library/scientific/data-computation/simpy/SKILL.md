...
whenToUse: Use when the task matches this skill's scope: Build, inspect, test, and analyze bounded process-based discrete-event simulations with SimPy, including events, resources, interrupts, monitoring, replications, warm-up, and reproducible output analysis.
allowedTools: [Read, Write, Edit, Bash, Glob]
domain: data-computation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/simpy/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/simpy/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

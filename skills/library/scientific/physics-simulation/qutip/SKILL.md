...
whenToUse: Use when the task matches this skill's scope: Simulate and audit closed and open quantum-system models with QuTiP 5, including deterministic, trajectory, steady-state, spectral, and phase-space workflows. Use for local quantum-dynamics work where physical assumptions, dimensions, and numerical convergence must be explicit.
allowedTools: [Read, Write, Edit, Bash]
domain: physics-simulation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/qutip/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/qutip/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

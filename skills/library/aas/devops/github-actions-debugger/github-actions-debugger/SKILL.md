...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — devops/github-actions-debugger · risk=safe · source=community · added=2026-06-25
whenToUse: "Use when a GitHub Actions workflow fails unexpectedly and the error log is long, obscure, or misleading."
allowedTools: []
---

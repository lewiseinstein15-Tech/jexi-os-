...
whenToUse: Use when the task matches this skill's scope: Develop and review PyLabRobot lab-automation resources, liquid-handling plans, offline simulations, and supported-device integrations. Use for PyLabRobot protocols or API questions; keep physical execution behind an explicit operator safety gate.
allowedTools: [Read, Write, Edit, Bash]
domain: lab-automation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/pylabrobot/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/pylabrobot/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

...
whenToUse: Use when the task matches this skill's scope: Use NeuroKit2 to build or audit reproducible research workflows for physiological time-series preprocessing, event/interval analysis, multimodal alignment, variability, and complexity. Trigger when code imports neurokit2 or needs its current APIs, schemas, and method-aware validation—not for diagnosis or device validation.
allowedTools: [Read, Write, Edit, Bash, Glob]
domain: clinical-informatics
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/neurokit2/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/neurokit2/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

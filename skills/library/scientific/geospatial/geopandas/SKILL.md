...
whenToUse: Use when the task matches this skill's scope: Guidance and local audit tools for Python workflows that directly use GeoPandas GeoSeries, GeoDataFrame, spatial operations, or vector-data I/O.
allowedTools: [Read, Write, Bash, Glob, Grep]
domain: geospatial
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/geopandas/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/geopandas/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

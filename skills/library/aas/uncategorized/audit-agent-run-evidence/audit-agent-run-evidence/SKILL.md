...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — uncategorized/audit-agent-run-evidence · risk=safe · source=self · added=2026-08-19
whenToUse: "Use when Auditing a completed or interrupted agent run from traces and artifacts."
allowedTools: []
---

...
whenToUse: Use when the task matches this skill's scope: Analyze Neuropixels extracellular recordings end-to-end with SpikeInterface. Covers loading SpikeGLX/Open Ephys/NWB data, preprocessing, drift/motion correction, Kilosort4 (and CPU) spike sorting, quality metrics, and unit curation (threshold-based, model-based UnitRefine, and AI-assisted visual review). Use when working with Neuropixels 1.0/2.0 recordings, spike sorting, or extracellular electrophysiology analysis.
allowedTools: [Read, Write, Edit, Bash]
domain: medical-imaging
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/neuropixels-analysis/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/neuropixels-analysis/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

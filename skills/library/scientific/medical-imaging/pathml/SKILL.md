...
whenToUse: Use when the task matches this skill's scope: "Use PathML for local, research-only computational pathology workflows: load and tile slides, build preprocessing and QC pipelines, manage h5path data, quantify multiplex images, construct spatial graphs, and plan bounded model inference."
allowedTools: [Read, Write, Edit, Bash, Glob]
domain: medical-imaging
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/pathml/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/pathml/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

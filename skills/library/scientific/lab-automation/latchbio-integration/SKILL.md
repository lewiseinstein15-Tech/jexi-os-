...
whenToUse: Use when the task matches this skill's scope: Build, register, debug, and operate bioinformatics workflows on Latch using the Python SDK, CLI, Latch Data and Registry, Nextflow, Snakemake, programmatic execution, and Latch MCP. Use when authoring or deploying Latch workflows, configuring resources or interfaces, moving data, integrating Registry, or launching and monitoring runs.
allowedTools: [Read, Write, Edit, Bash]
domain: lab-automation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/latchbio-integration/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/latchbio-integration/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

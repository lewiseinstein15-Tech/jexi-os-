...
whenToUse: Use when the task matches this skill's scope: Facilitates evidence-aware scientific ideation with independent generation, structured discussion, explicit assumptions, transparent evaluation, adversarial review, and decision logs. Use for early-stage research brainstorming or prioritizing candidate directions; hand off empirical validation, study design, ethics or regulatory review, and clinical questions to appropriate experts or skills.
allowedTools: [Read, Write, Edit, Bash]
domain: research-workflow
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/scientific-brainstorming/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/scientific-brainstorming/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

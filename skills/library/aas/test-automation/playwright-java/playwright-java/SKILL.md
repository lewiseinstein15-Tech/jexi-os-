...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — test-automation/playwright-java · risk=safe · source=community · added=2025-03-08
whenToUse: "Use when scaffolding a new Playwright Java project from scratch"
allowedTools: []
---

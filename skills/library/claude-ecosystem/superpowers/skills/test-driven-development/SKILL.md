...
## Import Provenance
- Source: obra/superpowers `skills/test-driven-development/SKILL.md` @ `5bf4e7801107`; body ported verbatim.
...
- External files: NOT vendored — upstream ships 1 auxiliary file(s) (writing-good-tests.md).

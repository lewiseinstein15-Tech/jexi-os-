...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — workflow/antigravity-workflows · risk=none · source=self · added=2026-02-27
whenToUse: "Use when asked to ship a SaaS MVP, audit application security, build an AI agent, run browser QA, or design a domain model with multiple skills and verified checkpoints."
allowedTools: []
---

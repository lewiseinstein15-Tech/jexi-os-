...
check('P1: 251 agents · 507 skills · 177 tools (got ' + report.counts.agents + '/' + report.counts.skills + '/' + report.counts.tools + ')', report.counts.agents === 251 && report.counts.skills === 507 && report.counts.tools === 177); // +1: connector-call (B56)

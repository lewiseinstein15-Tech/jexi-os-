...
whenToUse: Use when the task matches this skill's scope: Use Therapeutics Data Commons through the PyTDC Python package for registry discovery, approved dataset access, task-aware splits, evaluator metrics, benchmark groups, and bounded molecular-oracle workflows.
allowedTools: [Read, Write, Edit, Bash]
domain: drug-discovery
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/pytdc/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/pytdc/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

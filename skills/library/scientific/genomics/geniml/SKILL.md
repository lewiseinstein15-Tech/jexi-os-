...
whenToUse: Use when the task matches this skill's scope: "Use Geniml for audited local genomic-interval workflows: validate BED and universe contracts, plan Region2Vec or scEmbed runs, inspect model/tokenizer compatibility, and assess consensus universes."
allowedTools: [Read, Write, Edit, Bash, Glob]
domain: genomics
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/geniml/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/geniml/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

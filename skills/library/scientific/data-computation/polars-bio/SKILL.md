...
whenToUse: Use when the task matches this skill's scope: High-performance genomic interval operations and bioinformatics file I/O on Polars DataFrames. Overlap, nearest, merge, coverage, complement, subtract for BED/VCF/BAM/GFF intervals. Streaming, cloud-native, faster bioframe alternative.
allowedTools: [Read, Write, Edit, Bash]
domain: data-computation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/polars-bio/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/polars-bio/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

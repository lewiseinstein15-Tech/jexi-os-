...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — business/odoo-automated-tests · risk=safe · source=self · added=2026-09-04
whenToUse: "Use when Writing unit tests for a custom model's business logic."
allowedTools: []
---

...
whenToUse: Use when the task matches this skill's scope: Run and analyze molecular dynamics simulations with OpenMM and MDAnalysis. Set up protein/small molecule systems, define force fields, run energy minimization and production MD, analyze trajectories (RMSD, RMSF, contact maps, free energy surfaces). For structural biology, drug binding, and biophysics.
allowedTools: [Read, Write, Edit, Bash]
domain: molecular-dynamics
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/molecular-dynamics/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/molecular-dynamics/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

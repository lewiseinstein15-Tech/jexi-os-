...
check('P1: 251 agents · 507 skills · 177 tools (got ' + report.counts.agents + '/' + report.counts.skills + '/' + report.counts.tools + ')', report.counts.agents === 251 && report.counts.skills === 507 && report.counts.tools === 187); // +1: spill-read (B100)

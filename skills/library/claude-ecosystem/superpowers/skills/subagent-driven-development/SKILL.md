...
## Import Provenance
- Source: obra/superpowers `skills/subagent-driven-development/SKILL.md` @ `5bf4e7801107`; body ported verbatim.
...
- External files: NOT vendored — upstream ships 6 auxiliary file(s) (implementer-prompt.md, re-review-prompt.md, scripts/review-package, scripts/sdd-workspace, scripts/task-brief, task-reviewer-prompt.md).

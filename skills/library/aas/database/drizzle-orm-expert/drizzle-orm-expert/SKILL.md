...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — database/drizzle-orm-expert · risk=safe · source=community · added=2026-03-04
whenToUse: "Use when the user asks to set up Drizzle ORM in a new or existing project"
allowedTools: []
---

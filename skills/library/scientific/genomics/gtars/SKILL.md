...
whenToUse: Use when the task matches this skill's scope: Use Gtars for local genomic interval models and set algebra, overlaps and counts, consensus and coverage, tokenization, fragment processing, and refget/BEDbase planning across Python, Rust, and the CLI.
allowedTools: [Read, Write, Edit, Bash, Glob]
domain: genomics
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/gtars/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/gtars/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

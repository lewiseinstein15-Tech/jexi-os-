...
name: bids
description: >
whenToUse: Use when the task matches this skill's scope: >
...
- Source: K-Dense-AI/scientific-agent-skills `skills/bids/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.
- License: MIT (upstream LICENSE.md, K-Dense Inc.); per-skill upstream license field: "https://creativecommons.org/licenses/by/4.0/".

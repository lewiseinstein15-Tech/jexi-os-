...
whenToUse: "Use when implementation is complete, all tests pass, and you need to decide how to integrate the work"
allowedTools: []
domain: claude-ecosystem
tier: reference-only
origin: obra/superpowers
upstreamPath: skills/finishing-a-development-branch/SKILL.md
...
## Import Provenance
- Source: obra/superpowers `skills/finishing-a-development-branch/SKILL.md` @ `5bf4e7801107`; body ported verbatim.
...
- External files: none — this skill is a single SKILL.md upstream.

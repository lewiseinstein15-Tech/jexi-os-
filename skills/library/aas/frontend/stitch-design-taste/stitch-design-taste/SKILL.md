...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — frontend/stitch-design-taste · risk=safe · source=community · added=2026-04-17
whenToUse: "Use when the user wants a Google Stitch-compatible DESIGN.md or semantic design system for AI screen generation."
allowedTools: []
---

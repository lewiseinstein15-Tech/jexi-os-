...
tools: [claude, cursor]
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — development-and-testing/openclaw-github-repo-commander · risk=safe · source=community · added=2026-03-18
whenToUse: "Use when you need to audit a repository for secrets, junk files, or low-quality content"
allowedTools: []
---

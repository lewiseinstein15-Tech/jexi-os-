...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — security/client-secret-exposure-audit · risk=safe · source=self · added=2026-09-10
whenToUse: "Use when you need to check whether a deployed site leaks API keys, tokens, or"
allowedTools: []
---

...
whenToUse: Use when the task matches this skill's scope: Distributed computing for larger-than-RAM pandas/NumPy workflows. Use when you need to scale existing pandas/NumPy code beyond memory or across clusters. Best for parallel file processing, distributed ML, integration with existing pandas code. For out-of-core analytics on single machine use vaex; for in-memory speed use polars.
allowedTools: [Read, Write, Edit, Bash]
domain: data-computation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/dask/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/dask/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

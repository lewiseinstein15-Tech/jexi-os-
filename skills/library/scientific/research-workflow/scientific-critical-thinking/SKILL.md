...
whenToUse: Use when the task matches this skill's scope: Evaluate scientific claims and evidence quality. Use for assessing experimental design validity, identifying biases and confounders, applying evidence grading frameworks (GRADE, Cochrane Risk of Bias), or teaching critical analysis. Best for understanding evidence quality, identifying flaws. For formal peer review writing use peer-review.
allowedTools: [Read, Write, Edit]
domain: research-workflow
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/scientific-critical-thinking/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/scientific-critical-thinking/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

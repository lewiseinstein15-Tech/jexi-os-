...
whenToUse: Use when the task matches this skill's scope: Securely integrate with the official LabArchives ELN REST-like API and Inventory API v1. Use for regional endpoint selection, signed-request construction, user authorization and UID flows, local LA container validation, and verified LabArchives integration workflows.
allowedTools: [Read, Write, Edit, Bash]
domain: lab-automation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/labarchive-integration/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/labarchive-integration/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

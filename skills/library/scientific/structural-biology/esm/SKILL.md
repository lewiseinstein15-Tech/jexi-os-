...
whenToUse: Use when the task matches this skill's scope: Use when working directly with the `esm` Python SDK, ESM3 or ESMC model IDs, Forge/Biohub inference clients, or ESMFold2 folding workflows.
allowedTools: [Read, Write, Edit, Bash]
domain: structural-biology
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/esm/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/esm/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

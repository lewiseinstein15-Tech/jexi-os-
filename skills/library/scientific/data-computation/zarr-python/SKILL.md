...
whenToUse: Use when the task matches this skill's scope: Chunked N-D arrays for cloud storage (Zarr-Python 3). Compressed arrays, parallel I/O, S3/GCS via fsspec, NumPy/Dask/Xarray compatible, for large-scale scientific computing pipelines.
allowedTools: [Read, Write, Edit, Bash]
domain: data-computation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/zarr-python/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/zarr-python/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

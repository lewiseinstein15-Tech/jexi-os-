...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — devops/aegisops-ai · risk=safe · source=community · added=2026-03-24
whenToUse: "Use when **Kernel Patch Review:** Auditing raw C-based Git diffs for memory safety."
allowedTools: []
---

...
## Import Provenance
- Source: obra/superpowers `skills/brainstorming/SKILL.md` @ `5bf4e7801107`; body ported verbatim.
...
- External files: NOT vendored — upstream ships 7 auxiliary file(s) (scripts/frame-template.html, scripts/helper.js, scripts/server.cjs, scripts/start-server.sh, scripts/stop-server.sh, spec-document-reviewer-prompt.md, …).

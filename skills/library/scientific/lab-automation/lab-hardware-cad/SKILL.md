...
whenToUse: Use when the task matches this skill's scope: Design custom laboratory hardware as parametric build123d models and export fabrication-ready STEP, STL, and DXF files - microfluidic chips and molds, optomechanical mounts and breadboard adapters, cuvette and microplate holders, tube racks, animal-behavior rigs, and 3D-printed instrument fixtures. Use when a research task needs a physical part that must mate with standardized labware, an optical table, a cage system, or a printer, CNC, or laser process.
allowedTools: [Read, Write, Edit, Bash, Glob, Grep]
domain: lab-automation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/lab-hardware-cad/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/lab-hardware-cad/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

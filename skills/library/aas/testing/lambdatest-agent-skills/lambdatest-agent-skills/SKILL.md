...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — testing/lambdatest-agent-skills · risk=safe · source=community · added=2026-04-16
whenToUse: "Use when you need to write, scaffold, or review test automation code for any major framework"
allowedTools: []
---

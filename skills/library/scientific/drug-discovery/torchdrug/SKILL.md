...
whenToUse: Use when the task matches this skill's scope: Build and troubleshoot TorchDrug 0.2.1 workflows for molecular graphs, property prediction, self-supervised pretraining, molecule generation, retrosynthesis, protein representation learning, and knowledge graph reasoning. Use when code imports torchdrug or needs its datasets, models, tasks, or Engine.
allowedTools: [Read, Write, Edit, Bash]
domain: drug-discovery
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/torchdrug/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/torchdrug/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

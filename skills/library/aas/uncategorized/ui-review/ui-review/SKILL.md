...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — uncategorized/ui-review · risk=safe · source=https://github.com/bitjaru/styleseed/tree/main/engine/.claude/skills/ss-review · added=2026-07-01
whenToUse: "Use when For accessibility-only issues → use `/ss-a11y`"
allowedTools: []
---

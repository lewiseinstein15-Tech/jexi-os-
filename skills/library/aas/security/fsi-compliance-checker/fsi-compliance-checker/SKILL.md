...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — security/fsi-compliance-checker · risk=safe · source=community · added=2026-06-12
whenToUse: "Use when a change touches payment card data (PAN, CVV, track data) and needs a PCI-DSS check"
allowedTools: []
---

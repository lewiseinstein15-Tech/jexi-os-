...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — workflow/acceptance-orchestrator · risk=safe · source=community · added=2026-03-12
whenToUse: "Use when The task already has an issue or clear acceptance criteria and should run end-to-end with minimal human re-intervention."
allowedTools: []
---

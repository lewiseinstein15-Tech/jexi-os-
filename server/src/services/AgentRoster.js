...
export const SKILL_REGISTRY = [
  ...
  { slug: 'hardware', name: 'Hardware', category: 'Engineering', desc: 'PCB, firmware, electronics, and embedded systems design.', agent: 'electrical-engineer' },
  { slug: 'embedded', name: 'Embedded', category: 'Engineering', desc: 'Embedded software, firmware, and microcontroller systems.', agent: 'electrical-engineer' },
  { slug: 'iot', name: 'IoT', category: 'Engineering', desc: 'Internet of Things: sensors, connectivity, edge devices, and device clouds.', agent: 'electrical-engineer' },

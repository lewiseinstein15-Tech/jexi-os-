...
whenToUse: "Render Markdown from templates and structured data using Knap CLI. Use when the user asks to apply a Knap template, turn JSON or CSV data into notes, batch-generate Markdown files, or format Defuddle output into a note."
allowedTools: []
domain: obsidian
tier: reference-only
origin: kepano/obsidian-skills
upstreamPath: skills/knap/SKILL.md
...
## Import Provenance
- Source: kepano/obsidian-skills `skills/knap/SKILL.md` @ `3ccff5338ea700537839b21900aa5358a0402c98`; body ported verbatim.

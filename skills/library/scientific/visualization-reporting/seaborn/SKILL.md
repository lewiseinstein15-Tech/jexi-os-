...
whenToUse: Use when the task matches this skill's scope: Statistical visualization with pandas integration. Use for quick exploration of distributions, relationships, and categorical comparisons with attractive defaults. Best for box plots, violin plots, pair plots, heatmaps. Built on matplotlib. For interactive plots use plotly; for publication styling use scientific-visualization.
allowedTools: [Read, Write, Edit, Bash]
domain: visualization-reporting
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/seaborn/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/seaborn/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

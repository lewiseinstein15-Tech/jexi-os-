...
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — testing/agent-qa-result-triage · risk=safe · source=https://github.com/vostride/agent-qa/tree/main/skills/agent-qa-result-triage · added=2026-08-16
whenToUse: "Use when Investigating a failed or interrupted Agent QA run."
allowedTools: []
---

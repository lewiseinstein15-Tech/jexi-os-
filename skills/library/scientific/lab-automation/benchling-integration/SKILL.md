...
whenToUse: Use when the task matches this skill's scope: Benchling Python SDK and REST API integration for registry entities, inventory, ELN entries, workflows, Benchling Apps, and Data Warehouse queries. Use when automating lab data with benchling-sdk or the v2 API.
allowedTools: [Read, Write, Edit, Bash]
domain: lab-automation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/benchling-integration/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/benchling-integration/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

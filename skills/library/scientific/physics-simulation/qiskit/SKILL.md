...
whenToUse: Use when the task matches this skill's scope: Build, simulate, transpile, and execute quantum circuits with Qiskit and IBM Quantum Runtime. Use for Qiskit 2.x circuits and operators, V2 Sampler or Estimator primitives, target-aware transpilation, local or noisy simulation, IBM QPU execution, Runtime sessions or batches, error mitigation, and Qiskit ecosystem packages.
allowedTools: [Read, Write, Edit, Bash]
domain: physics-simulation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/qiskit/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/qiskit/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

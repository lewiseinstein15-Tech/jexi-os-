...
upstreamPath: skills/writing-skills/SKILL.md
...
## Import Provenance
- Source: obra/superpowers `skills/writing-skills/SKILL.md` @ `5bf4e7801107`; body ported verbatim.
...
- External files: NOT vendored — upstream ships 6 auxiliary file(s) (anthropic-best-practices.md, examples/CLAUDE_MD_TESTING.md, graphviz-conventions.dot, persuasion-principles.md, render-graphs.js, testing-skills-with-subagents.md).

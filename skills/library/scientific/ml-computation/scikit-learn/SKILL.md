...
whenToUse: Use when the task matches this skill's scope: Machine learning in Python with scikit-learn. Use when working with supervised learning (classification, regression), unsupervised learning (clustering, dimensionality reduction), model evaluation, hyperparameter tuning, preprocessing, or building ML pipelines. Provides comprehensive reference documentation for algorithms, preprocessing techniques, pipelines, and best practices.
allowedTools: [Read, Write, Edit, Bash]
domain: ml-computation
tier: reference-only
origin: K-Dense-AI/scientific-agent-skills
upstreamPath: skills/scikit-learn/SKILL.md
...
- Source: K-Dense-AI/scientific-agent-skills `skills/scikit-learn/SKILL.md` @ `330c8e764435` (release 2.69.0); body ported verbatim.

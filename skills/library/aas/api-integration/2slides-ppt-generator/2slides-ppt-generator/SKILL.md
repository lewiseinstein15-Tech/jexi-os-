...
plugin:
  setup:
    ...
    docs: SKILL.md
version: 1
origin: sickn33/antigravity-awesome-skills (MIT/CC-BY-4.0) — api-integration/2slides-ppt-generator · risk=safe · source=community · added=2026-06-05
whenToUse: "Use when the user asks to \"create a presentation\", \"make slides\", or \"generate a deck\" from text or an outline."
allowedTools: []
---
